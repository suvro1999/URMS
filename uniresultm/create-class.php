                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Create Semesters</h2>
                                </div>
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- 1s year 1st semester,Third year 2nd semester,etc</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Eg- DEO-1, DEO-2</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Eg- Day or Night</span>
                                                        </div>
                                                    </div>
  <div class="form-group has-success">
