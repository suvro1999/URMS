                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT tblTeacher.StudentName,tblTeacher.RollId,tblTeacher.RegDate,tblTeacher.StudentId,tblTeacher.Status,tblclasses.ClassName,tblclasses.Section from tblTeacher join tblclasses on tblclasses.id=tblTeacher.ClassId";
