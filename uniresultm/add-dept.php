...
<html lang="en">
    <head>
        ...
        <title>URMS Admin| Department Admission< </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Department Admission</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Department Admission</li>
                                    </ul>
                                </div>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Passwoerd</label>
<div class="col-sm-10">
<input type="password" name="rollid" class="form-control" id="rollid" maxlength="5" required="required" autocomplete="off">
</div>
                                                    ...
                                                    <!-- <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Generate password</label>
